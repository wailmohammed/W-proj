...
import { LayoutDashboard, PieChart, DollarSign, Search, Users, Settings, LogOut, Activity, ChevronDown, PlusCircle, Check, Shield, Bell, X, BarChart2, Landmark, Crown, Moon, Sun, Cloud, CloudOff } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  ...
  // Robust fallback: Ensure portfolios is an array and provide a safe default object
  ...
  return (
    <>
      {/* Mobile Overlay - High Z-Index to cover App Header */}
      {isOpen && (
        <div 
